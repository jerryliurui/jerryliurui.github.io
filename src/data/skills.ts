...
export const skillsData: Skill[] = [
	...
	},
	{
		...
		name: "Objective-C",
		description:
			"Objective-C is a key programming language for Apple platforms. It combines C syntax with object-oriented features, featuring dynamic runtime and message passing.",
		icon: "logos:apple",
		category: "frontend",
		level: "expert",
		experience: { years: 11, months: 8 },
		projects: [],
		color: "#003B57",
	},
	{
	...
	},
	{
		id: "xcode",
		name: "Xcode",
		description: "A lightweight but powerful code editor from Apple.",
		icon: "logos:xcode",
		category: "tools",
		level: "expert",
