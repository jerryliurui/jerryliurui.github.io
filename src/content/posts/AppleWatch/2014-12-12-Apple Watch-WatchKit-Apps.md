...
![Alt text](/images/applewatch/layoutsubviews.png)
...
![Alt text](/images/applewatch/configView.png)
...
![Alt text](/images/applewatch/maininterface.png)
...
![Alt text](/images/applewatch/defaulttext.png)
...
![Alt text](/images/applewatch/configrowcontroller.png)
...
![Alt text](/images/applewatch/showrowlabel.png)
...
![Alt text](/images/applewatch/menu.png)

每一个菜单按钮都有一个可点击的区域和一个标题，可点击区域都有一个固定的颜色背景，上部可以自己提供一个图片，这个图片有一些特殊的要求，具体的布局如下：

![Alt text](/images/applewatch/menubutton.png)
...
![Alt text](/images/applewatch/threemenubutton.png)
...
![Alt text](/images/applewatch/fourmenubutton.png)
