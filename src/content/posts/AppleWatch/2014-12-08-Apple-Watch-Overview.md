...
![Alt text](/images/applewatch/three.png)
...
![Alt text](/images/applewatch/creatapplewatch.png)

![Alt text](/images/applewatch/creatapplewatch2.png)
...
![Alt text](/images/applewatch/structureforwatch.png)

对于Watch APP来说，build、run、debug都是自动配置好的，但是对于glance以及notification需要自己手动的配置，编辑它们的Scheme就可以了。

![Alt text](/images/applewatch/editscheme.png)
...
![Alt text](/images/applewatch/CommunicationbetweenaWatchappandWatchKitextension.png)
...
![Alt text](/images/applewatch/Lifecycleofaninterfacecontroller.png)
