---
title: 类网易新闻跟贴 Label 动画
published: 2017-05-30
pinned: false
image: "/images/LabelAnimation/neteaseAnimation.gif"
description: "复盘一个类似网易新闻跟贴数字跳动效果的 Label 动画实现。"
tags: ["iOS", "Animation", "Label"]
category: iOS
author: JerryLiu
---
### 0.前言 
...
![](/images/LabelAnimation/neteaseAnimation.gif)
...
![](/images/LabelAnimation/animationHelperFuncs.png)
...
`进行动画`：
![](/images/LabelAnimation/playAnimation.png)

具体的代码在demo中都可以找到，DEMO的效果GIF是这样的：（GIF看上去会有卡顿。。动画不流畅和完整）
![](/images/LabelAnimation/demoAnimation.gif)
