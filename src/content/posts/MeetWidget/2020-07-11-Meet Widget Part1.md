...
![Alt text](/images/WidgetPart1/Simulator Screen Shot - iPhone Xs Max - 2020-07-04 at 16.50.48.png)
...
![Alt text](/images/WidgetPart1/Simulator Screen Shot - iPhone SE (2nd generation) - 2020-07-04 at 17.00.29.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.06.22.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.06.36.png)

关于可编辑性，系统提供了统一的UI，我们可以定义不同的页面参数来让系统帮我们把页面呈现出来，而参数的类型的不同，系统会给出不同的展示样式，例如数字的编辑

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.06.42.png)

这部分灵活度不高，我们只能定制这个面板的背景颜色，和控件的小背景颜色，下边我修改成了红色和小灰色

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.06.49.png)

而多亏了可编辑性，用户可以同时在一个屏幕内看到两个同样的Widget，来展示不同的信息，最大化满足用户的需求

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.06.58.png)

2.3Multiples

多样性，我们的App可以同时提供多种功能的Widget给用户来选择，极大了方便了我们的App把更多的核心功能呈现在用户的桌面上

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.10.png)

2.4大小和交互意见

Widget分为小，中，大，如图所示，分别占用了4、8、16个icon的大小

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.17.png)

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.22.png)

Small仅仅支持整个区域的点击，而中和大则可以提供更加丰富的点击，来进入到我们的主App来展示更细化的内容

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.29.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.43.png)

2.6Patterns

三种尺寸的大小，苹果都给出了一定的模板，但是其实这只是一个参考，尽量贴合即可。

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.49.png)

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.54.png)

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.07.58.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.04.png)


关于整个容器，padding.all 需要保持在16pt，而在代码层面，我们使用default padding即可展示正确

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.08.png)


关于圆形内容，我们的最小边距是11pt

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.13.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.19.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.26.png)

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.30.png)


苹果推荐内容源很杂的App来放一个logo在Widget上，但是切记不能直接放原生App的icon，可以是一个简易的Logo，且只能放在右上角

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.35.png)

![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.08.42.png)
...
![Alt text](/images/WidgetPart1/截屏2020-07-04 下午5.37.29.png)
